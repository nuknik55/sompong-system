...
const EXCEPTIONS: Record<string, string> = {
  ...
  "app/owner/catering/actions.ts:getCateringEventTypes": "the event-type picker list (2026-09-25): the table policies decide",
  "app/owner/sales-import-actions.ts:getPosImportMeta": "the POS import's last period and time (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getApprovedLeavesForMonth": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getApprovedLeavesForWeek": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getAttendanceDailyMonth": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getAttendanceYearSummary": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getCompDayBalances": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getDaySwapRequests": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getDepartments": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getEmployee": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getEmployeePayrollHistory": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getEmployees": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getHolidayCompDayBalances": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getHolidays": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getLeaveQuotas": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getLeaveRequests": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getLeaveTypes": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getPayrollEntries": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getPayrollPeriods": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getProbationAlerts": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getScheduleWeek": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getSwapDatesForMonth": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getSwapDatesForWeek": "HR read with no guard of its own (2026-09-25): the table policies decide",
  "app/owner/hr/actions.ts:getUnpaidOtHours": "HR read with no guard of its own (2026-09-25): the table policies decide",
};
