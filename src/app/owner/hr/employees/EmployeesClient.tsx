...
export function EmployeesClient({
  ...
  function openEdit(emp: Employee) {
    ...
    setForm({
      ...
      daily_wage: emp.daily_wage ?? null,
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Field label="เงินเดือน (บาท)">
                  <input
                    type="number"
                    className="input-base"
                    value={form.base_salary ?? ""} placeholder="—"
                ...
                <Field label="ค่าตำแหน่ง (บาท)">
                  <input
                    type="number"
                    className="input-base"
                    value={form.position_allowance ?? ""} placeholder="—"
                ...
                <Field label="ประกันสังคม (ต่อเดือน)">
                  ...
                  <input
                    type="number"
                    className="input-base"
                    value={form.social_security_monthly ?? ""} placeholder="—"
